...
class TDataGridColumn {
    ...
    private $name; // nome da coluna no banco de dados
    private $label; // rótulo de texto que será exibido
    private $align; // alinhamento
     ...
     * @param String $label rótulo de texto que será exibido
     * @param String $align alinhamento da coluna (left, center, right)
     * @param int $width largura da coluna (em pixels)
     */
